...
//// admin -pa /////
    ...
    return api.sendMessage('[ ديدوز ۦۦٰۦﮩ ] - ممنوع استخدام البوت الان فقط من قبل المطور 💜', threadID, messageID)
    ////end 
    if (!ADMINBOT.includes(senderID) && adminbot.adminOnly == true) {
      if (!ADMINBOT.includes(senderID) && adminbot.adminOnly == true) return api.sendMessage('[ ديدوز ۦۦٰۦﮩ ] - ممنوع استخدام البوت الان فقط من قبل المطور 💜', threadID, messageID)
    }
    if (!NDH.includes(senderID) && !ADMINBOT.includes(senderID) && adminbot.ndhOnly == true) {
      if (!NDH.includes(senderID) && !ADMINBOT.includes(senderID) && adminbot.ndhOnly == true) return api.sendMessage('[ ديدوز ۦۦٰۦﮩ ] - ممنوع استخدام البوت الان فقط من قبل المطور 😽', threadID, messageID)
    }
