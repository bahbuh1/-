...
module.exports.onLoad = async () => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/Pg7p8Jm.jpeg", path);
};
...
async function makeImage({ one, two }) {
  ...
  hiepdam_image.composite(circleOne.resize(250, 250), 171, 187).composite(circleTwo.resize(1, 1), 1, 1);
